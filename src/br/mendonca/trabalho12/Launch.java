...
import br.mendonca.trabalho12.estruturas.ThiagoBarrosEstrutura;
import br.mendonca.trabalho12.sorts.ThiagoBarrosSort;
import br.mendonca.trabalho12.tads.ThiagoBarrosTAD;

public class Launch {
	public static void main(String[] args) {
		ISort sort = new ThiagoBarrosSort();
		ITrabalho12 listaEstatica = new ThiagoBarrosEstrutura(10);
		...
		System.out.println("\nTentando dar sort antes de ter elementos na lista: " + listaEstatica.print());
		sort.insert(listaEstatica);
		...
		System.out.println("\nOrdem da lista antes: " + listaEstatica.print());
		...
		System.out.println("\nOrdem da lista depois: " + listaEstatica.print());
		System.out.println("\nDouble referente ao elemento 1: " + listaEstatica.getItem(0).getDouble());
		System.out.println("\nDouble referente ao elemento 2: " + listaEstatica.getItem(1).getDouble());
		System.out.println("\nDouble referente ao elemento 3: " + listaEstatica.getItem(2).getDouble());
		System.out.println("\nDouble referente ao elemento 4: " + listaEstatica.getItem(3).getDouble());
